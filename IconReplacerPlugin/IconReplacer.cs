...
namespace IconReplacerPlugin
{
    public class IconReplacer
    {
        ...
        private IconReplacerConfiguration Configuration;
        ...
        private ulong GetIconDetour(byte self, uint actionID)
        {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.DragoonCoerthanTormentCombo))
            {
                if (actionID == 16477)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.DragoonChaosThrustCombo))
            {
                if (actionID == 88)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.DragoonFullThrustCombo))
            {
                if (actionID == 84)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.DarkSouleaterCombo))
            {
                if (actionID == 3632)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.DarkStalwartSoulCombo))
            {
                if (actionID == 16468)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.PaladinGoringBladeCombo))
            {
                if (actionID == 3538)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.PaladinRoyalAuthorityCombo))
            {
                if (actionID == 3539)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.PaladinProminenceCombo))
            {
                if (actionID == 16457)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.WarriorStormsPathCombo))
            {
                if (actionID == 42)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.WarriorStormsEyeCombo))
            {
                if (actionID == 45)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.WarriorMythrilTempestCombo))
            {
                if (actionID == 16462)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SamuraiYukikazeCombo))
            {
                if (actionID == 7480)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SamuraiGekkoCombo))
            {
                if (actionID == 7481)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SamuraiKashaCombo))
            {
                if (actionID == 7482)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SamuraiMangetsuCombo))
            {
                if (actionID == 7484)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SamuraiOkaCombo))
            {
                if (actionID == 7485)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.NinjaArmorCrushCombo))
            {
                if (actionID == 3563)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.NinjaAeolianEdgeCombo))
            {
                if (actionID == 2255)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.NinjaHakkeMujinsatsuCombo))
            {
                if (actionID == 16488)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.GunbreakerSolidBarrelCombo))
            {
                if (actionID == 16145)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.GunbreakerGnashingFangCombo))
            {
                if (actionID == 16146)
                {
                    byte ammoComboState = this.ClientState.JobGauges.Get<GNBGauge>().AmmoComboStepNumber;
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.GunbreakerDemonSlaughterCombo))
            {
                if (actionID == 16149)
                {
                    if (comboTime > 0)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.MachinistHeatedClanShotFeature))
            {
                if (actionID == 7413)
                {
                    MCHGauge gauge = this.ClientState.JobGauges.Get<MCHGauge>();
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.MachinistSpreadShotFeature))
            {
                if (actionID == 2870)
                {
                    if (this.ClientState.JobGauges.Get<MCHGauge>().IsOverheated() && level >= 52) return 16497;
                    return 2870;
                }
            }
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.BlackEnochianFeature))
            {
                if (actionID == 3575)
                {
                    BLMGauge jobInfo = this.ClientState.JobGauges.Get<BLMGauge>();
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.BlackManaFeature))
            {
                if (actionID == 149)
                {
                    BLMGauge gauge = this.ClientState.JobGauges.Get<BLMGauge>();
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.AstrologianCardsOnDrawFeature))
            {
                if (actionID == 17055)
                {
                    ASTGauge gauge = this.ClientState.JobGauges.Get<ASTGauge>();
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SummonerDwtCombo))
            {
                if (actionID == 3581)
                {
                    SMNGauge gauge = this.ClientState.JobGauges.Get<SMNGauge>();
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SummonerDemiCombo))
            {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SummonerBoPCombo))
            {
                if (actionID == 163)
                {
                    SMNGauge gauge = this.ClientState.JobGauges.Get<SMNGauge>();
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SummonerEDFesterCombo))
            {
                if (actionID == 16508)
                {
                    if (this.ClientState.JobGauges.Get<SMNGauge>().HasAetherflowStacks())
                        return 181;
                    return 16508;
                }
            }
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.SummonerESPainflareCombo))
            {
                if (actionID == 16510)
                {
                    if (this.ClientState.JobGauges.Get<SMNGauge>().HasAetherflowStacks())
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.ScholarSeraphConsolationFeature))
            {
                if (actionID == 16543)
                {
                    if (this.ClientState.JobGauges.Get<SCHGauge>().SeraphTimer > 0) return 16546;
                    return 16543;
                }
            }

            // Change Energy Drain into Aetherflow when you have no more Aetherflow stacks.
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.ScholarEnergyDrainFeature))
            {
                if (actionID == 167)
                {
                    if (this.ClientState.JobGauges.Get<SCHGauge>().NumAetherflowStacks == 0) return 166;
                    return 167;
                }
            }
            ...
            */
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.DancerAoeGcdFeature))
            {
                if (actionID == 15994)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.DancerFanDanceCombo))
            {
                if (actionID == 16007)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.WhiteMageSolaceMiseryFeature))
            {
                if (actionID == 16531)
                {
                    if (this.ClientState.JobGauges.Get<WHMGauge>().NumBloodLily == 3)
                        return 16535;
                    return 16531;
                }
            }
            ...
            // Replace Solace with Misery when full blood lily
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.WhiteMageRaptureMiseryFeature))
            {
                if (actionID == 16534)
                {
                    if (this.ClientState.JobGauges.Get<WHMGauge>().NumBloodLily == 3)
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.BardWandererPPFeature))
            {
                if (actionID == 3559)
                {
                    if (this.ClientState.JobGauges.Get<BRDGauge>().ActiveSong == CurrentSong.WANDERER)
                    {
                        return 7404;
                    }
                    return 3559;
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.BardStraightShotUpgradeFeature))
            {
                if (actionID == 97)
                {
            ...
            */
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.RedMageAoECombo))
            {
                if (actionID == 16525)
                {
            ...
            if (this.Configuration.ComboPresets.HasFlag(CustomComboPreset.RedMageMeleeCombo))
            {
                if (actionID == 7516)
                {
                    RDMGauge gauge = this.ClientState.JobGauges.Get<RDMGauge>();
